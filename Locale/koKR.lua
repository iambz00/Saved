...
L["Usage_Character"] = {
    ...
    { "[화폐:ID]"       , "또는 화폐 링크(화폐 탭에서 시프트 클릭)" , "" , "아이콘과 수량"   ,   },
    { "[화폐:골드]"     , "[화폐:실버]"         , "[화폐:코퍼]"     ,   },
    { " |cffff0000!|r 획득 상한 화폐 표기 방식(미지정 시 0과 2 중 자동 선택)" , },
    { "[화폐:396-0]"    , "|T463447:14:14|t960"  , "[화폐:396-1]"   , "|T463447:14:14|t960(-5140)"   },
    { "[화폐:396-2]"    , "|T463447:14:14|t960(|cFFFF75755140|r)"   , "[화폐:396-3]"    , "|T463447:14:14|t960(4460/9600)"  },
}
L["Usage_Instance"] = {
